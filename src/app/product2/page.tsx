          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed text-gray-700">
                ...
                porro ex ratione voluptatum blanditiis architecto suscipit
                quisquam, laborum animi ipsam, quasi atque, dolor quaerat
                dolorum culpa nulla delectus tempore aspernatur?
              </p>
                ...
                <button className="flex items-center justify-center w-[212px] h-[63px] bg-[#029FAE] text-white py-3 rounded-md">
                  ...
                  >
                    <path
                      ...
                      d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13L5 20h14m-9 0a1 1 0 102 0m-4 0a1 1 0 102 0"
                    />
                  </svg>
                  {/* Cart Text */}
                  Add to Cart
